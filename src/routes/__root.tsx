...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Assessoria completa de casamentos. Cuidamos dos bastidores para você viver o seu dia com leveza." },
    ...
    links: [
      ...
      { rel: "preload", as: "font", type: "font/woff2", href: "/fonts/work-sans-normal-300_600-latin.woff2", crossOrigin: "anonymous" },
      { rel: "preload", as: "font", type: "font/woff2", href: "/fonts/instrument-serif-normal-400-latin.woff2", crossOrigin: "anonymous" },
  ...
  return (
    <html lang="pt-BR">
      ...
      <body>
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-MF3XXKBJ"
            height="0"
            width="0"
